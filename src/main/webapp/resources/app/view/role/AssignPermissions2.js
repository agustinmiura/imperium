 ...
 * static table .
 * Use with the widget Chooser.js
 * 
 */
	...
	var createConfigForButtons = function() {
		...
		var onSuccessBeforeAddCb = function(data) {
			...
			if (data["success"] === true) {
				...
				var result = imperium_ui_widget_Chooser.addToSelectionIds(
						"#permissionSelector #selectorPluginId10", add);
			}
...
//		var toSearchConfig = {
//			url : "/imperium/permission/ajax/list/1",
//			method : "GET",
